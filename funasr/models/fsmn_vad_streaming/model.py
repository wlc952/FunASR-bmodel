...
class FsmnVADStreaming(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.fsmn_model = EngineOV(kwargs["model_path"]+"/fsmn_fp32.bmodel", device_id=kwargs['dev_id'])
        #self.fsmn_model = EngineOV(kwargs["model_path"]+"/fsmn_fp16.bmodel", device_id=kwargs['dev_id'])
